...
mod tests {
    ...
    use alloy_primitives::{b256, bloom, hex, Address, Log, LogData};
    ...
    fn check_receipt_root_optimism() {
        ...
        let encoded_rlp = hex!("");
        let encoded_rlp2= hex!("");
        let receopt1 = ReceiptWithBloom::<TypedReceipt>::decode_2718_exact(&encoded_rlp).unwrap();
        let receopt2 = ReceiptWithBloom::<TypedReceipt>::decode_2718_exact(&encoded_rlp2).unwrap();
        println!("Decoded receipt 1: {:?}", receopt1);
        println!("Decoded receipt 2: {:?}", receopt2);
